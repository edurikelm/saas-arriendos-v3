---
name: docs-writer
description: Actualiza CONTEXT.md, ADRs y docs de agentes cuando cambian reglas de dominio, arquitectura o workflow en RentalPro. Usar despues de una decision durable de producto, dominio o proceso que deba quedar registrada.
