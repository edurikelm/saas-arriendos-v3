...
export function CalendarShowcase() {
  const mockReservations: Reservation[] = [
    {
      ...
      status: "CONFIRMED",
      bookingAirbnb: true,
      notes: "Cliente prefiere silencio",
      property: { id: "1", name: "Casa del Lago", color: "#3B82F6" },
      client: { id: "1", name: "María García", email: "maria.garcia@gmail.com" },
      payments: [
        { id: "p1", amount: "200000", status: "COMPLETED", method: "MERCADO_PAGO" },
        { id: "p2", amount: "225000", status: "PENDING", method: "TRANSFER" },
      ],
    },
    {
      id: "2",
      ...
      bookingAirbnb: false,
      notes: null,
      property: { id: "2", name: "Departamento Centro", color: "#10B981" },
      client: { id: "2", name: "Carlos Rodríguez", email: "carlos.r@outlook.com" },
      payments: [],
    },
    {
      id: "3",
      ...
      status: "COMPLETED",
      bookingAirbnb: true,
      notes: "Dejó llave en mailboxes",
      property: { id: "3", name: "Cabaña Andes", color: "#F59E0B" },
      client: { id: "3", name: "Ana Martínez", email: "ana.martinez@gmail.com" },
      payments: [
        { id: "p3", amount: "600000", status: "COMPLETED", method: "MERCADO_PAGO" },
      ],
    },
    {
      id: "4",
      ...
      property: { id: "1", name: "Casa del Lago", color: "#3B82F6" },
      client: { id: "4", name: "Pedro Sánchez", email: "pedro.s@gmail.com" },
      payments: [],
    },
    {
      id: "5",
      ...
      notes: null,
      property: { id: "2", name: "Departamento Centro", color: "#10B981" },
      client: { id: "5", name: "Laura Fernández", email: "laura.f@gmail.com" },
      payments: [
        { id: "p5", amount: "340000", status: "COMPLETED", method: "TRANSFER" },
      ],
    },
  ];
  ...
  return (
    <div className="space-y-12 p-8">
      <div>
        <h2 className="text-2xl font-bold mb-2">Calendar Prototypes</h2>
        <p className="text-muted-foreground">Distintas variantes de vistas para el calendario</p>
      </div>
      ...
      <section>
        <h3 className="text-lg font-semibold mb-4 text-muted-foreground">Grid Mensual - Spacious</h3>
        <Card>
          <CardContent className="p-6">
            <CalendarMonthGrid
              reservations={mockReservations}
              currentMonth={currentMonth}
              onSelectReservation={(id) => setSelectedReservation(mockReservations.find((r) => r.id === id) || null)}
      ...
      <section>
        <h3 className="text-lg font-semibold mb-4 text-muted-foreground">Grid Mensual - Comfortable (Default)</h3>
        <Card>
          <CardContent className="p-6">
            <CalendarMonthGrid
              reservations={mockReservations}
      ...
      <section>
        <h3 className="text-lg font-semibold mb-4 text-muted-foreground">Grid Mensual - Minimal</h3>
        <Card>
      ...
      <section>
        <h3 className="text-lg font-semibold mb-4 text-muted-foreground">Timeline Horizontal</h3>
        <Card>
          <CardContent className="p-6">
            <CalendarTimeline
              reservations={mockReservations}
      ...
      <section>
        <h3 className="text-lg font-semibold mb-4 text-muted-foreground">Lista Cronológica</h3>
        <Card>
          <CardContent className="p-6">
            <CalendarList
              reservations={mockReservations}
      ...
      <section>
        <h3 className="text-lg font-semibold mb-4 text-muted-foreground">Vista Semanal</h3>
        <Card>
          <CardContent className="p-6">
            <CalendarWeekView
              reservations={mockReservations}
