...
export function ReservationCardShowcase() {
  ...
  return (
    <div className="space-y-12 p-8">
      <div>
        <h2 className="text-2xl font-bold mb-2">Reservation Card Prototypes</h2>
        <p className="text-muted-foreground">Distintas variantes de cards para reservas</p>
      </div>
      ...
      <section>
        ...
        <div className="space-y-3">
          {mockReservations.map((reservation) => (
            <ReservationCardMinimal
              key={reservation.id}
              reservation={reservation}
              onView={() => console.log("View", reservation.id)}
              onEdit={() => console.log("Edit", reservation.id)}
              onCancel={() => console.log("Cancel", reservation.id)}
              onDelete={() => console.log("Delete", reservation.id)}
            />
          ))}
        </div>
      </section>
      ...
      <section>
        <h3 className="text-lg font-semibold mb-4 text-muted-foreground">Timeline</h3>
        <div className="pl-2">
          {mockReservations.map((reservation) => (
            <ReservationCardTimeline
              key={reservation.id}
              reservation={reservation}
              onView={() => console.log("View", reservation.id)}
              onEdit={() => console.log("Edit", reservation.id)}
      ...
      <section>
        <h3 className="text-lg font-semibold mb-4 text-muted-foreground">Kanban (por estado)</h3>
      ...
      <section>
        <h3 className="text-lg font-semibold mb-4 text-muted-foreground">Tabla</h3>
        <ReservationTable
      ...
      <section>
        <h3 className="text-lg font-semibold mb-4 text-muted-foreground">Tabla Cards (Grid)</h3>
        <ReservationTableCards
          reservations={mockReservations}
          onView={(id) => console.log("View", id)}
          onEdit={(id) => console.log("Edit", id)}
        />
