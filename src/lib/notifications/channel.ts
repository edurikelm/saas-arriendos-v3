...
export interface NotificationIntent {
  ...
  type: "RESERVATION_CREATED" | "RESERVATION_CANCELLED" | "PAYMENT_RECEIVED" | "PAYMENT_REVERTED" | "PAYMENT_REMINDER" | "PAYMENT_FAILED" | "SUBSCRIPTION_ACTIVATED" | "SUBSCRIPTION_CANCELLED" | "SUBSCRIPTION_EXPIRED";
  title: string;
  body: string;
  link?: string;
  userId: string;
