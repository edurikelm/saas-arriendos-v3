...
export function DashboardMonthPulse({ month }: DashboardMonthPulseProps) {
  ...
  return (
    ...
    <section aria-labelledby="mes-heading">
      ...
      {/* Lado a lado donde la columna da ~435px (2xl): apilados miden ~294px
          y alargan la columna de propiedades. A 1280px la columna mide
          ~304px y un KPI de 145px no alcanza para el monto. */}
